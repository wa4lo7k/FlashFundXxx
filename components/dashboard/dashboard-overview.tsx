...
export function DashboardOverview() {
  ...
  const pricingData = {
    "1k": { instant: 89, hft: 149, oneStep: 49, twoStep: 0.5 },
      ...
      <div className="space-y-8">
            ...
            return (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href="/dashboard/buy-challenge">
        ...
        <div className="text-center glass-card p-8 rounded-2xl border border-slate-800/30">
          ...
          <p className="text-slate-400 mb-6 max-w-2xl mx-auto">
            ...
            Select your account type above and buy your first challenge.
          </p>
          <Link href="/dashboard/buy-challenge">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/dashboard/buy-challenge">
              <div className="glass-card p-6 rounded-xl border border-slate-800/30 hover:border-slate-700/50 transition-all duration-300 hover:scale-105 cursor-pointer group">
                ...
                <p className="text-slate-400 text-sm font-medium">Purchase additional trading accounts</p>
              </div>
            </Link>
